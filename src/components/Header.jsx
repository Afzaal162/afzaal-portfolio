export default function Header() {
    return (
        <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            <img src="./assets/header.png" alt="" className="rounded-full w-40" />
            <h3 className="flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo">
                Hi! I&apos;m Afzaal Hassan
                <img src="./assets/hand-icon.png" alt="" className="w-6 mb-1" />
            </h3>
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">Full Stack Web Developer Based in Pakistan.</h1>
            <p className="max-w-2xl mx-auto font-Ovo">I am a Full Stack Specialist in the MERN and PERN stacks, focused on engineering scalable web applications and integrating intelligent Generative AI features.</p>
